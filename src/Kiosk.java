...
public class Kiosk {
    public static final int ADDBOOKARGUMENTS = 2;
    ...
    public void run() {
        ...
        while(running){
            ...
            switch (input.nextToken()){
                case "A":
                    if(input.countTokens()==ADDBOOKARGUMENTS){
                        try {
                ...
                case "I":
                    if(input.countTokens()==1) {
                        String serialNumber = input.nextToken();
                        try {
                            if(library.returns(library.findBook(serialNumber)))
                                System.out.println("Book#"+serialNumber+" has completed. Thanks!");
                            else
